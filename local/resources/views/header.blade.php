...
?>
 ...
 <div id="m_nav_container" class="m_nav">
  ...
  <ul class="navbar-nav ml-auto">
                <li class="active dropdown yamm-fw"> <a href="<?php echo $url;?>" data-hover="dropdown" class="dropdown-toggle disabled" data-toggle="dropdown">@lang('languages.home')</a> </li>
               ...
               <?php
					...
					$subcat_cnt = DB::table('subcategory')
									...
									->count();			 		 
					?>
                <li> <a href="<?php echo $url;?>/shop/cat/<?php echo $views->id;?>/<?php echo $views->post_slug;?>" class="dropdown-toggle <?php if(empty($subcat_cnt)){?>disabled<?php } ?>" data-toggle="dropdown"><?php echo $views->cat_name;?> <?php if(!empty($subcat_cnt)){?><i class="fa fa-angle-down" aria-hidden="true"></i><?php } ?></a>
                ...
                <a href="javascript:void(0)" class="nav-link  dropdown-toggle" data-toggle="dropdown">@lang('languages.pages')</a>
    ...
    <div class="container-fluid">
      ...
      <div class="cnt-block">
          <ul class="list-unstyled list-inline">
            ...
            <li class="dropdown dropdown-small"> <a href="<?php echo $url;?>/dashboard" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><i class="icon fa fa-user"></i><span class="value">@lang('languages.my_account')</span><b class="caret"></b></a>
              <?php if(Auth::guest()) { ?>
        ...
        <div class="cnt-account hider">
          <ul class="list-unstyled">
           <li><a href="<?php echo $url;?>/compare"><i class="icon fa fa-compress"></i>@lang('languages.compare')</a></li>
            <li><a href="<?php echo $url;?>/my-wishlist"><i class="icon fa fa-heart"></i>@lang('languages.wishlist')</a></li>
            <li><a href="<?php echo $url;?>/cart"><i class="icon fa fa-shopping-cart"></i>@lang('languages.my_cart')</a></li>
        ...
        <div class="col-xs-6 col-sm-6 col-md-2 logo-holder"> 
          ...
          <?php if(!empty($setts[0]->site_logo)){?>
		   ...
		   <a href="<?php echo $url;?>"><img src="<?php echo $url.'/local/images/media/'.$setts[0]->site_logo;?>" alt="<?php echo $setts[0]->site_name;?>" /></a>
		   <?php } else {?>
  ...
  <div id="m_nav_menu" class="m_nav">
    ...
    <div class="m_nav_ham" id="m_ham_3"></div>
        ...
        <div class="search-area">
             ...
             <form class="register-form" role="form" method="POST" action="{{ route('shop') }}" id="formIDwel" enctype="multipart/form-data">
                            {{ csrf_field() }}
              <div class="control-group">
                <ul class="categories-filter animate-dropdown">
					...
					?>
                    <option value="<?php echo $views->id;?>_cat" <?php if(!empty($category_field)){?> <?php if($category_field==$views->id.'_cat'){?> selected="selected" <?php } } ?>><?php echo $views->cat_name;?>
                ...
                <input class="search-field" name="search_text" <?php if(!empty($search_txt)){?> value="<?php echo $search_txt;?>" <?php } ?> placeholder="@lang('languages.search_here')" />
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 animate-dropdown top-cart-row"> 
          ...
          <div class="dropdown dropdown-cart"> <a href="<?php echo $url;?>/cart" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
            <div class="items-cart-inner">
              <div class="basket"> <i class="glyphicon glyphicon-shopping-cart"></i> </div>
              <div class="basket-item-count"><span class="count"><?php echo $cart_views_count;?></span></div>
              <div class="total-price-basket"> <span class="total-price"> <span class="sign"><?php echo $setts[0]->site_currency;?></span> <span class="value"><?php echo number_format($price_values,2);?></span> </span> </div>
            </div>
            </a>
            <ul class="dropdown-menu">
              ...
              <?php if(!empty($cart_views_count)){?>
                  ...
                  <div class="row">
                    <div class="col-xs-4">
                      ...
                      <?php
														...
														?>
                                                        <a href="<?php echo $url;?>/product/<?php echo $product->prod_id;?>/<?php echo $view_product[0]->prod_slug;?>"><img src="<?php echo $url;?>/local/images/media/<?php echo $product_img[0]->image;?>" alt=""></a>
                                                        <?php } else { ?>
                                                        <a href="<?php echo $url;?>/product/<?php echo $product->prod_id;?>/<?php echo $view_product[0]->prod_slug;?>"><img src="<?php echo $url;?>/local/images/noimage_box.jpg" alt=""></a>
                                                        <?php } ?>
                      </div>
                    </div>
                    <div class="col-xs-7">
                    ...
                    <div class="col-xs-1 action"> <a href="<?php echo $url;?>/cart/<?php echo $product->ord_id;?>" onClick="return confirm('@lang('languages.are_you_sure')');"><i class="fa fa-trash"></i></a> </div>
                  </div>
                </div>
                ...
                <div class="clearfix cart-total">
                  <div class="pull-right"> <span class="text">@lang('languages.subtotal') :</span><span class='price'><?php echo $setts[0]->site_currency.' '.number_format($price_val,2).' ';?></span> </div>
                  <div class="clearfix"></div>
                  <a href="<?php echo $url;?>/cart" class="btn btn-upper btn-primary btn-block m-t-20">@lang('languages.cart')</a> </div>
              ...
              <?php if(empty($cart_views_count)){?>
                                             <li><div align="center">@lang('languages.your_cart_is_empty')</div></li>
                                             <?php } ?>
            ...
            <div class="nav-outer">
              <ul class="nav navbar-nav">
               ...
               <?php
                ...
                <li class="dropdown"> <a href="javascript:void(0)" class="dropdown-toggle  disabled" data-hover="dropdown" data-toggle="dropdown">@lang('languages.pages')</a>
