	...
	@endif
		...
		<div class="row ">
			<div class="shopping-cart">
                ...
                <div class="col-md-6 text-right"><a href="<?php echo $url;?>/add-product" class="btn-upper btn btn-primary">@lang('languages.add_product')</a> <a href="<?php echo $url;?>/importExport" class="btn-upper btn btn-primary">@lang('languages.goto_import_export')</a></div>
            ...
            <?php if(!empty($viewcount)){?>
				...
				<tr>
                    ...
                    <?php
                        ...
                        <a href="<?php echo $url;?>/product/<?php echo $product->prod_id;?>/<?php echo $product->prod_slug;?>" class="entry-thumbnail"><img src="<?php echo $url;?>/local/images/media/<?php echo $product_img[0]->image;?>" alt="" class="img_responsive"></a>
                                                        <?php } else { ?>
                                                        <a href="<?php echo $url;?>/product/<?php echo $product->prod_id;?>/<?php echo $product->prod_slug;?>" class="entry-thumbnail"><img src="<?php echo $url;?>/local/images/noimage_box.jpg" alt="" class="img_responsive"></a>
                                                        <?php } ?>
					...
					<td class="cart-product-name-info">
						<h4 class='cart-product-description'><a href="<?php echo $url;?>/product/<?php echo $product->prod_id;?>/<?php echo $product->prod_slug;?>"><?php echo $product->prod_name;?></a></h4>
                    ...
                    <a href="<?php echo $url;?>/edit-product/<?php echo $product->prod_token;?>" title="edit" class="icon"><i class="fa fa-edit"></i></a>
                    <a href="<?php echo $url;?>/my-product/<?php echo $product->prod_token;?>" title="delete" class="icon" onClick="return confirm('@lang('languages.are_you_sure')');"><i class="fa fa-trash-o"></i></a></td>
				</tr>
				<?php }  } ?>
			</tbody><!-- /tbody -->
		</table><!-- /table -->
