		...
		<table class="table">
            ...
            <?php if(!empty($viewcount)){?>
					...
					<td class="cart-product-name-info">
						<h4 class="cart-product-description"><a href="<?php echo $url;?>/product/<?php echo $product->prod_id;?>/<?php echo $product_slug;?>"><?php echo $product_names;?></a></h4>
                    ...
                    <td class="cart-product-sub-total"><?php echo $product->status;?></td>
