...
<div class="body-content">
    ...
    <?php if(!empty($viewproduct[0]->stripe_token)){?>
    <div class="col-md-6 ">
		
       
        
			<div class="form-group">
		    <label class="fontnromal" for="exampleInputName"><strong>@lang('languages.stripe_txn_id'): </strong> <?php echo $viewproduct[0]->stripe_token;?></label>
