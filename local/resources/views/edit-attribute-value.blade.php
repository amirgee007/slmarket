	...
	<div class="container-fluid">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>@lang('languages.edit_attribute_value')</li>
			</ul>
		</div>
	</div>
</div>
	...
	<div class="alert alert-danger">
		...
		<ul>
			...
			<div class="shopping-cart">
                ...
                <div class="col-md-6"><div class="heading-title" style="border-bottom:none !important;">@lang('languages.edit_attribute_value')</div></div>
	...
	<div class="table-responsive">
        ...
        <form class="register-form" role="form" method="POST" action="{{ route('edit-attribute-value') }}" id="formID" enctype="multipart/form-data">
                    {{ csrf_field() }}
						...
						<option value="">@lang('languages.select')</option>
                        ...
                        <?php foreach($attribute_type as $type){?>
                                ...
                                <p class="form-row col-sm-12">
                                    <label for="product_name">@lang('languages.value')<abbr title="required" class="required">*</abbr></label>
                                     ...
                                     <input type="text" name="attribute_name" id="attribute_name" value="<?php echo $attribute[0]->attr_value;?>" class="form-control unicase-form-control validate[required]">
                                </p>
