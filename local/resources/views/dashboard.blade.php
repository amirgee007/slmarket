...
<div class="body-content">
	...
	<div class="alert alert-danger">
     ...
     <div class="col-md-12 row"><div class="heading-title">@lang('languages.dashboard')</div></div>
    ...
    <form class="register-form" role="form" method="POST" action="{{ route('dashboard') }}" id="formID" enctype="multipart/form-data">
        {{ csrf_field() }}
    ...
    <div class="col-md-6 contact-form">
                        ...
                        <div class="form-group">
                            ...
                            <select name="gender" class="form-control unicase-form-control">
							  ...
							  <option value="">Gender</option>
							   <option value="male" <?php if($editprofile[0]->gender=="male"){?> selected <?php } ?>>Male</option>
							   <option value="female" <?php if($editprofile[0]->gender=="female"){?> selected <?php } ?>>Female</option>
							</select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Address" name="address" class="form-control unicase-form-control" value="<?php echo $editprofile[0]->address;?>">
                            </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea placeholder="About Description" name="about" class="form-control unicase-form-control" style="min-height:150px;"><?php echo $editprofile[0]->about;?></textarea>
                            </div>
                            </div>
	...
	<div class="tab-pane m-t-20" id="billingDetail" style="display:none;">
        ...
        <div class="col-md-12">
                        ...
                        <div class="form-group">
                         ...
                         <label class="info-title" for="exampleInputName">@lang('languages.address') </label>
                            <input type="text" placeholder="Address" name="bill_address" class="form-control unicase-form-control" value="<?php if(!empty($edited_count)){?><?php echo $edited[0]->bill_address;?><?php } ?>">
              ...
              <div class="col-md-12">
                        ...
                        <div class="form-group">
                         ...
                         <label class="info-title" for="exampleInputName">@lang('languages.address') </label>
                             ...
                             <input type="text" placeholder="Address" name="ship_address" class="form-control unicase-form-control" value="<?php if(!empty($edited_count)){?><?php echo $edited[0]->ship_address;?><?php } ?>">
