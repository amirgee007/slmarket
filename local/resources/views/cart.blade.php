...
<div class="body-content outer-top-xs">
    <div class="container-fluid">
        ...
        <div class="row ">
            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ route('checkout') }}" id="formID"
                        ...
                        <div class="table-responsive">
							...
							<span class="">
								<a href="<?php echo $url;?>/shop"
                                   class="btn btn-upper btn-primary outer-left-xs">@lang('languages.continue_shopping')</a>
                                ...
                                <tr>
                                    <td class="romove-item">
                                        ...
                                        <a href="<?php echo $url;?>/cart/<?php echo $product->ord_id;?>"
                                           onClick="return confirm('@lang('languages.are_you_sure')');" title="cancel"
                                           class="icon"><i class="fa fa-trash-o"></i></a>

                                    </td>

                                    <td class="romove-item">
                                        <a href="<?php echo $url;?>/product/<?php echo $product->prod_id;?>/<?php echo $view_product[0]->prod_slug;?>"
                                    ...
                                    <td class="cart-product-name-info">
                                        <h4 class='cart-product-description'>
                                            ...
                                            <a href="<?php echo $url;?>/product/<?php echo $product->prod_id;?>/<?php echo $view_product[0]->prod_slug;?>"><?php echo $view_product[0]->prod_name;?></a>
                                        </h4>
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <th>
                                    ...
                                    <div class="height20 clearfix"></div>
                                    <div class="cart-grand-total">
                                        <label>@lang('languages.shipping_charge')</label><span
                                                class="inner-left-md"> <select
                                                    class="unicase-form-control validate[required]" id="billing_country"
                                                    name="shipping_charge" style="width:150px;">
                                                <option value="">Select</option>
                                            	<option value="local_shipping">Local shipping (<?php echo $admin_details[0]->country;?>
                                                    )</option>
                            ...
                            <tr>
                                <td>
                                    <div class="cart-checkout-btn pull-right">
                                        ...
                                        <input type="submit" class="btn btn-primary checkout-btn" name="checkout"
                                               value="@lang('languages.proceed_to_checkout')">
