		...
		<table class="table">
            ...
            <?php if(!empty($cart_views_count)){?>
				...
				<tr>
                    ...
                    <a href="<?php echo $url;?>/cart/<?php echo $product->ord_id;?>" onClick="return confirm('@lang('languages.are_you_sure')');" title="cancel" class="icon"><i class="fa fa-trash-o"></i></a>
                    
                    </td>
                    
                    <td class="romove-item">
                    <a href="<?php echo $url;?>/product/<?php echo $product->prod_id;?>/<?php echo $view_product[0]->prod_slug;?>" title="edit" class="icon"><i class="fa fa-edit"></i></a>
                    </td>
					...
					<td class="cart-image">
                        ...
                        <?php
														...
														?>
                                                        <a href="<?php echo $url;?>/product/<?php echo $product->prod_id;?>/<?php echo $view_product[0]->prod_slug;?>" class="entry-thumbnail"><img src="<?php echo $url;?>/local/images/media/<?php echo $product_img[0]->image;?>" alt="" ></a>
                                                        <?php } else { ?>
                                                        <a href="<?php echo $url;?>/product/<?php echo $product->prod_id;?>/<?php echo $view_product[0]->prod_slug;?>" class="entry-thumbnail"><img src="<?php echo $url;?>/local/images/noimage_box.jpg" alt="" ></a>
                                                        <?php } ?>
