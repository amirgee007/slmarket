...
<div class="body-content">
	...
	@endif
        ...
        <div class="row">
        <div class="col-md-12">
        <div class="col-md-6"><div class="heading-title" style="border-bottom:none !important;">@lang('languages.all_vendors')</div></div>
        ...
        <?php foreach($user_view as $vendor){
		...
		if(!empty($star_count))
		{
			...
			foreach($star_views as $review){
			  ...
			  $over_01 +=$review->rating;
				...
				if(!empty(round($fine_value_01/$over_01))){ $roundeding_01 = round($fine_value_01/$over_01); } else {
		        $roundeding_01 = 0; }		   
		...
		if(!empty($star_count))
	                                           ...
	                                           if($roundeding_01==1){ $rateus_new_01 ='
                                                <p class="review-icon">
                                                    <span>
												...
												if($roundeding_01==2){ $rateus_new_01 ='
                                                <p class="review-icon">
                                                    <span>
                                                    <i class="fa fa-star" aria-hidden="true"></i>
                                                    <i class="fa fa-star" aria-hidden="true"></i>
												...
												if($roundeding_01==3){ $rateus_new_01 ='
                                                <p class="review-icon">
                                                    <span>
                                                    <i class="fa fa-star" aria-hidden="true"></i>
                                                    <i class="fa fa-star" aria-hidden="true"></i>
												...
												if($roundeding_01==4){ $rateus_new_01 ='
                                                <p class="review-icon">
                                                    <span>
                                                    <i class="fa fa-star" aria-hidden="true"></i>
                                                    <i class="fa fa-star" aria-hidden="true"></i>
												...
												if($roundeding_01==5){ $rateus_new_01 ='
                                                <p class="review-icon">
                                                    <span>
                                                    <i class="fa fa-star" aria-hidden="true"></i>
                                                    <i class="fa fa-star" aria-hidden="true"></i>
											    ...
											    else if(empty($roundeding_01)){  $rateus_new_01 = '
												<p class="review-icon">
                                                    <span>
        ...
        <div class="col-lg-3 col-sm-6">
            ...
            <div class="card hovercard">
                <div style='background: url("<?php echo $path;?>"); background-size: cover; height: 135px;'>
				...
				$userphoto_two="/media/";
						...
						?>
                <div class="avatar">
                    <a href="<?php echo $url;?>/profile/<?php echo $vendor->id;?>/<?php echo $vendor->post_slug;?>"><img alt="" src="<?php echo $path_two;?>"></a>
                </div>
                <div class="info">
                    <div class="title">
                        <a href="<?php echo $url;?>/profile/<?php echo $vendor->id;?>/<?php echo $vendor->post_slug;?>"><?php echo $vendor->name;?></a>
                    </div>
                    ...
                    <div class="height10"></div>
                   <?php if(!empty($star_count)){ echo $rateus_new_01; } else { echo $rateus_empty_01; }?>
