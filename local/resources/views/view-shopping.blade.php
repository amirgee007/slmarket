	...
	@endif
		...
		<div class="row " id="pcontent">
			<div class="shopping-cart">
                ...
                <div class="col-md-6 text-right"><a href="<?php echo $url;?>/my-shopping" class="btn-upper btn btn-primary">@lang('languages.back_to_my_shopping')</a>
           ...
           <?php if(!empty($viewcount)){?>
					...
					<td class="cart-image">
                        ...
                        <?php
														...
														?>
                                                        <a href="<?php echo $url;?>/product/<?php echo $product->prod_id;?>/<?php echo $product_slug;?>" class="entry-thumbnail"><img src="<?php echo $url;?>/local/images/media/<?php echo $product_img[0]->image;?>" alt="" class="img_responsive"></a>
                                                        <?php } else { ?>
                                                        <a href="<?php echo $url;?>/product/<?php echo $product->prod_id;?>/<?php echo $product_slug;?>" class="entry-thumbnail"><img src="<?php echo $url;?>/local/images/noimage_box.jpg" alt="" class="img_responsive"></a>
                                                        <?php } ?>
                    ...
                    <td><a href="<?php echo $url;?>/product/<?php echo $product->prod_id;?>/<?php echo $product_slug;?>"><?php echo $product_names;?></a>
                    <?php 
					if(!empty($view_count))
					{
					if($view_product[0]->prod_type=="digital"){ if($product->status=="completed"){?>
                    <br/><br/>
                    <span style="color:#FF0000;">@lang('languages.download_file'):</span> <a style="color:#0033CC;" href="<?php echo $url;?>/local/images/media/<?php echo $view_product[0]->prod_zipfile;?>" download><?php echo $view_product[0]->prod_zipfile;?></a>
					...
					<td class="cart-product-sub-total"><a href="<?php echo $url;?>/profile/<?php echo $product->prod_user_id;?>/<?php echo $prod_userslug;?>" class="theme_color"><?php echo $prod_usernames;?></a></td>
					<td class="cart-product-grand-total">
                    
                    
                    <?php if($product->status=="completed"){?>
                                                        
                                                        <a data-toggle="modal" data-target="#myModal<?php echo $product->ord_id;?>" style="color:#000099; cursor:pointer;">@lang('languages.click_rating_review')</a>		                      <?php if($ratinger==1){?>
                                                        <p class="review-icon">
                                        ...
                                        <div class="col-xs-12 marB30">
                                            <figure>
                                                <?php
														...
														?>
                                                        <a href="<?php echo $url;?>/product/<?php echo $product->prod_id;?>/<?php echo $product_slug;?>"><img src="<?php echo $url;?>/local/images/media/<?php echo $product_img[0]->image;?>" alt="" style="width:100%; max-width:350px;"></a>
                                                        <?php } else { ?>
                                                        <a href="<?php echo $url;?>/product/<?php echo $product->prod_id;?>/<?php echo $product_slug;?>"><img src="<?php echo $url;?>/local/images/noimage_box.jpg" alt="" style="width:100%; max-width:350px;"></a>
                                                        <?php } ?>
                                            </figure>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="caption price-box  marB30">
                                                ...
                                                <h5 class="color-gray"><a href="<?php echo $url;?>/product/<?php echo $product->prod_id;?>/<?php echo $product_slug;?>"><?php echo $product_names;?></a></h5>
                                            </div>
                                        </div>
