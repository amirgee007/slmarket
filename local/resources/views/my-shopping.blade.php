		...
		<table class="table">
			<thead>
				<tr>
					...
					<th class="item">@lang('languages.stripe_id')</th>
					<th class="item">@lang('languages.total_amount')</th>
					<th class="item">@lang('languages.payment')</th>
           ...
           <?php if(!empty($viewcount)){?>
                    ...
                    <td style="text-align:center;<?php if($product->payment_status=="completed"){?>color:#006600;<?php } if($product->payment_status=="pending"){?>color:#FF0000;<?php } ?>"><?php echo $product->payment_status;?></td>
