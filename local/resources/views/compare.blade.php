		...
		<!-- Description Element -->
			...
			<div class="ptsTableElementContent ptsElArea">
				<div class="ptsColHeader ptsCell" style="height: 186px;">
                    ...
                    <a href="<?php echo $url;?>/product/<?php echo $view_product[0]->prod_id;?>/<?php echo $view_product[0]->prod_slug;?>"><img src="<?php echo $url;?>/local/images/media/<?php echo $product_img[0]->image;?>" alt="" class="img_responsive"></a>
                                                        <?php } else { ?>
                                                        <a href="<?php echo $url;?>/product/<?php echo $view_product[0]->prod_id;?>/<?php echo $view_product[0]->prod_slug;?>"><img src="<?php echo $url;?>/local/images/noimage_box.jpg" alt="" class="img_responsive"></a>
                                                        <?php } ?>
      ...
      $over_02 +=$review->rating;
		  ...
		  $roundeding_02 = 0; }	
				...
				<div class="ptsColDesc compare_heading" style="height: 103px;">
					<div class="ptsEl " data-el="table_cell_txt" data-type="txt" style="" ><p><span style="" data-mce-style="color: #9d9d9d;" > <a href="<?php echo $url;?>/product/<?php echo $view_product[0]->prod_id;?>/<?php echo $view_product[0]->prod_slug;?>"><?php echo $view_product[0]->prod_name;?></a></span></p></div>
				</div>
				<div class="ptsRows ui-sortable" style="height: auto;">
					<div class="ptsCell" style="height: 76px;">
					...
					<div class="ptsCell" style="height: 200px;">
						<div class="ptsEl" data-el="table_cell_txt" data-type="txt" style="text-align:left;"><p><?php echo substr($view_product[0]->prod_desc,0,400);?></p></div>
					</div>
					<div class="ptsCell" style="height: 54px;">
				...
				<div class="ptsColFooter" style="height: 120px;">
					...
					<div class="ptsActBtn ptsEl ptsElInput" data-el="btn" data-bgcolor="#90c820" data-bgcolor-to="bg" data-bgcolor-elements="a">
						<a href="<?php echo $url;?>/product/<?php echo $view_product[0]->prod_id;?>/<?php echo $view_product[0]->prod_slug;?>" class="btn-upper btn btn-primary">@lang('languages.add_to_cart')</a>
					</div>
