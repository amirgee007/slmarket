            ...
            <div class="shopping-cart">
                <div class="shopping-cart-table ">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-md-3">
                            <form role="form" method="POST" action="{{ route('my-balance') }}" id="sellerID"
                                ...
                                <input type="hidden" name="available_amount"
                                       value="<?php echo $get_users_stage1[0]->earning;?>">

                                <div class="form-group">
                                    <p class="black">@lang('languages.withdraw_option') :</p>

                                    <select id="withdraw_type" name="withdraw_type"
                                            class="form-control unicase-form-control radiusoff validate[required]"
                                            onChange="javascript:withdraw_checking(this.value);">
                                ...
                                <div class="form-group" id="paypal" style="display:none;">
                                    ...
                                    <input type="text"
                                           class="form-control unicase-form-control validate[required] text-input"
                                           id="paypal_id" name="paypal_id">
                                </div>
                                ...
                                <div id="localbank" style="display:none;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               class="form-control unicase-form-control validate[required] text-input"
                                               id="bank_acc_no" name="bank_acc_no">
                                ...
                                <div class="form-group">
                                    <input type="submit" name="submit" class="btn-upper btn btn-primary"
                                           value="@lang('languages.send')">
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-md-12">
                            <div class="fontsize24 black">@lang('languages.pending_withdrawal')</div>
                        </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-md-12">
                            <div class="fontsize24 black">@lang('languages.completed_withdrawal')</div>
                        </div>
                        <div class="clearfix height20"></div>
                        <div class="col-md-12">
                            <div class="table-responsive">
