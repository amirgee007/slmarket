  ...
  <div class="container-fluid"><hr>
	...
	@endif
        ...
        <div class="widget-box">
         ...
         <?php $url = URL::to("/"); ?>   
                   <form class="form-horizontal form-label-left" role="form" method="POST" action="{{ route('admin.editsubcategory') }}" enctype="multipart/form-data"  id="formID">
                     {{ csrf_field() }}  
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  <input id="name" class="validate[required] span8"  name="name" value="<?php echo $subcategory[0]->subcat_name; ?>" type="text">
                        @if ($errors->has('name'))
