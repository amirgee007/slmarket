  ...
  <div class="container-fluid"><hr>
	...
	@endif
        ...
        <div class="widget-box">
         ...
         <?php $url = URL::to("/"); ?>   
                   <form class="form-horizontal form-label-left" role="form" method="POST" action="{{ route('admin.editcategory') }}" enctype="multipart/form-data" id="formID">
                     {{ csrf_field() }}  
              ...
              <div class="control-group">
                ...
                <div class="controls">
                 <input id="name" class="validate[required] span8"  name="name" value="<?php echo $category[0]->cat_name; ?>" type="text">
						  @if ($errors->has('name'))
              ...
              <div class="control-group">
                <label class="control-label">Display Main Menu?</label>
                <div class="controls">
                 
                                
                   <input id="display_menu" name="display_menu" <?php if(!empty($category[0]->display_menu)){?> checked <?php } ?> value="1" type="checkbox">
