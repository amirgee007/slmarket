                        ...
                        <table class="table table-bordered data-table" id="datatable-responsive">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="disabletxt">( <?php echo config('global.demotxt');?> )</span> <a
                                            href="#" class="btn btn-success btndisable">Mark as complete</a>
                                    <?php } else { ?>
                                    <a href="<?php echo $url;?>/admin/pending_withdraw/<?php echo base64_encode($view_withdraw->wid);?>"
