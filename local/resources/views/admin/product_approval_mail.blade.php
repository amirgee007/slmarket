...
<head>
    ...
    <title>Your Product is Approved</title>
...
<body>
	...
	<div class="container">
	 <h1><?php echo $site_name;?> - Your product is approved</h1>
	...
	font-weight: normal;line-height: 1.4em;color: #444;margin-top: 10px; padding:10px;">
			...
			<h3> Your product has been approved.Thank You!!</h3>
			<p> Product Name - <a href="<?php echo $url;?>/product/<?php echo $id;?>/<?php echo $slug;?>"><?php echo $product_name;?></a></p>
            <br/><br/>
